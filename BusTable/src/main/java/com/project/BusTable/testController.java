...
public class testController {
    ...
    private String CLIENT_ID = "aUdvllNgDAbs1OlxHk_H";
    private String CLI_SECRET = "hUPqAkdMd0";
    ...
    public String testNaver(HttpSession session, Model model) throws UnsupportedEncodingException, UnknownHostException {
        String redirectURI = URLEncoder.encode("http://localhost:8080/Nlogin/callback1", "UTF-8");
    ...
    @RequestMapping("/Nlogin/callback1")
     ...
     */
    @RequestMapping("/Nlogin/refreshToken")
     ...
     * @throws IOException
     */
    @RequestMapping("/Nlogin/deleteToken")
     ...
     */
    @ResponseBody
    @RequestMapping("/Nlogin/getProfile")
